...
<?php if ( get_header_image() ) : ?>
		...
		<nav id="site-navigation" class="main-navigation" role="navigation">
			...
			<a id="ipad" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php header_image(); ?>" class="header-image" width="<?php echo get_custom_header()->width; ?>" height="<?php echo get_custom_header()->height; ?>" alt="" /></a>
